(() => {
  ...
  // Keep every visible, translatable label in one place.  The former version
  // only translated the small group of labels above, which left each view
  // half translated.  A missing entry intentionally falls back to English.
  const pageCopy = {
    English: {
